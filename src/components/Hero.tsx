...
const Hero = () => {
  return (
    <section className='pb-36 pt-40'>
      ...
      <div>
        <div className='h-screen w-full dark:bg-black-100 bg-white  dark:bg-dot-white/[0.3] bg-dot-black/[0.2] flex items-center justify-center absolute top-0 left-0 pointer-events-none'>
